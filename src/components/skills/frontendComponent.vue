...
<style scoped>
    ...
    .html5{
        background-image: url('~@/assets/images/icons/html5.svg');
    }
    .css3{
        background-image: url('~@/assets/images/icons/css3.svg');
    }
    .js{
        background-image: url('~@/assets/images/icons/js.svg');
    }
    .vue{
        background-image: url('~@/assets/images/icons/vue.svg');
    }
